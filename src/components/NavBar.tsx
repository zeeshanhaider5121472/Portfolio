    ...
    <>
          ...
          >
            ...
            <button>
              {open ? (
                ...
                <HiOutlineMenuAlt4 className="text-gray-400 text-2xl" />
              )}
            </button>
          </div>
        </div>
      ...
      >
        <div className="flex flex-col gap-16">
          <div className="lg:text-6xl md:text-6xl text-5xl font-bold">
            <Link
              href="/"
              onClick={() => setOpen(!open)}
              className="text-transparent font-bold font-outline-white hover:text-purple-500 cursor-pointer"
            >
              Home
            </Link>
          </div>
        ...
        <div className="lg:flex md:flex hidden flex-col items-center justify-center gap-28">
            ...
            <div className="text-center">
              ...
              <div className="flex gap-4 text-2xl font-bold">
                <Link
                  ...
                  href="https://github.com/zeeshanhaider5121472/"
                >
                  GitHub
                </Link>
                <Link
                  className="text-sky-400 hover:text-white"
                  href="https://vercel.com/zeeshanhaider5121472s-projects"
                >
                  Vercel
                </Link>
                <Link
                  className="text-sky-400 hover:text-white"
                  href="https://www.linkedin.com/in/zeeshan-haider-80b50a179/"
                >
                  LinkedIn
                </Link>
                <Link
          ...
          <div className="text-center">
            <div className={oswald.className}>
              <p className="text-gray-400 text-lg font-medium mb-5">
                HAVE AN IDEA?
              </p>
            </div>
