      ...
      <div className="h-fit">
        <div className="flex flex-col items-end">
          <Link target="_blank" href={link}>
            <Image
              className="rounded-3xl lg:w-[24rem] md:w-[20rem] w-[18rem]"
              loading="eager"
              src={img}
              width={700}
              height={350}
          ...
          <Link target="_blank" href={link}>
            <h3 className="my-5 text-3xl font-bold text-right">
        ...
        <div className="flex justify-between my-6">
          <Link target="_blank" className={oswald.className} href={readme}>
            <div className="font-medium text-lg text-gray-400 border-b transition-all ease-in-out delay-[30ms] border-gray-400 w-[65%] hover:w-full">
              DETAILS
            </div>
          </Link>
